...
export class ListaDoblementeLigadaCanvas{
    ...
    async elimina_inicio_pre(inicio){
        ...
        this.dibujarNodo(0,0,nodo.info,"rgb(130,130,130)","black");//COLOR GRAY 
        ...
        while(nodo.ligaDer!=null){
            ...
            this.dibujarNodo(x,y,nodo.info,"rgb(255,255,255)","black");
    ...
    elimina_inicio_post(inicio){
        ...
        this.dibujarNodo(0,0,nodo.info,"rgb(255,255,255)","black");  
    ...
    inserta_inicio(inicio){
        ...
        if(inicio.ligaDer==null){//PRIMER NODO
            ...
            this.dibujarNodoAnimado(0,0,inicio.info,"rgb(255,255,255)","black");
            ...
            this.dibujarNodoAnimado(0,0,nodo.info,"rgb(255,255,255)","black");  
    ...
    inserta_final(inicio,final){
            ...
            this.dibujarNodoAnimado(x+80,0,nodo2.info,"rgb(255,255,255)","black");  
    ...
    async dibujarNodoAnimado(xFinal,yFinal,dato,colorFondo,colorTexto){
        ...
        for(let i=0;i<num;i++){//SOLO VERTICAL
            ...
            if(i==num-1)
                ...
                this.dibujarNodo(xTmp,yTmp,dato,"rgb(130,130,130)",colorTexto);
